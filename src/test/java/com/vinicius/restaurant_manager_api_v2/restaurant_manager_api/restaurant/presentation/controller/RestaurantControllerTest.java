...
class RestaurantControllerIntegrationTest {
    ...
    @Test
    void shouldCreateRestaurantWhenLoggedUserIsRestaurantOwner() throws Exception {
        RestaurantRequestDto request = new RestaurantRequestDto(
                "Pizzaria Roma", "Rua A, 123", KitchenType.ITALIAN,
                LocalTime.of(18, 0), LocalTime.of(23, 0), restaurantOwner.getId());
        ...
        mockMvc.perform(post("/api/v1/restaurants")
                ...
                .andExpect(jsonPath("$.name").value("Pizzaria Roma"));
    }

    @Test
    void shouldReturn403WhenCustomerTriesToCreateRestaurant() throws Exception {
        RestaurantRequestDto request = new RestaurantRequestDto(
                "Pizzaria Roma", "Rua A, 123", KitchenType.ITALIAN,
                LocalTime.of(18, 0), LocalTime.of(23, 0), customer.getId());
    ...
    @Test
    void shouldAllowCustomerToViewRestaurants() throws Exception {
    ...
    @Test
    void shouldReturn403WhenDeletingRestaurantOwnedBySomeoneElse() throws Exception {
    ...
    @Test
    void shouldDeleteRestaurantWhenLoggedUserIsOwner() throws Exception {
        Restaurant restaurant = Restaurant.create(
                "Pizzaria Roma", "Rua A, 123", KitchenType.ITALIAN,
                LocalTime.of(18, 0), LocalTime.of(23, 0), restaurantOwner);
        restaurantRepository.save(restaurant);
