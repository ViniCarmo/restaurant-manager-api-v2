...
class CreateMenuUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        createMenuUseCase = new CreateMenuUseCase(menuItemRepository, restaurantRepository, userRepository, authenticatedUserProvider);
    }
    ...
    @Test
    void shouldCreateMenuItemWhenLoggedUserIsOwner() {
        ...
        MenuItem result = createMenuUseCase.execute(
                "Pizza Margherita", "Molho e mussarela", new BigDecimal("45.90"),
                false, "/img.jpg", restaurantId);
    ...
    void shouldThrowExceptionWhenRestaurantDoesNotExist() {
        ...
        assertThrows(RestaurantNotFoundException.class,
                () -> createMenuUseCase.execute("Pizza", "desc", new BigDecimal("10"),
                        false, "/img.jpg", restaurantId));
