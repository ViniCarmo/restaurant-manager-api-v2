...
class DeleteMenuByIdUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        deleteMenuByIdUseCase = new DeleteMenuByIdUseCase(menuItemRepository, userRepository, restaurantRepository, authenticatedUserProvider);
    }
    ...
    @Test
    void shouldDeleteMenuItemWhenLoggedUserIsOwner() {
        ...
        deleteMenuByIdUseCase.execute(menuItemId);
